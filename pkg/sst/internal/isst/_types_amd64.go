...
// This file generates types_amd64.go and its compile-only non-amd64
// counterpart from the Linux/amd64 ABI. Only the amd64 ioctl transport can
// execute these declarations.
package isst
